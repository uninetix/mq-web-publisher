...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="${pageContext.request.contextPath}/"><img alt="Brand" height="20" src="${pageContext.request.contextPath}/decorators/img/Orange.gif"> Partner</a>
        </div>
